...
struct Locality: Decodable
{
	...
	let dependentLocality: LocalityDependentLocality?
...
struct LocalityDependentLocality: Decodable
{
	let dependentLocalityName: String?
	let dependentLocality: DependentLocalityDependentLocality?
...
struct DependentLocalityDependentLocality: Decodable
{
	let dependentLocalityName: String?
...
typealias GeoObjectResults = Result<GeoObjects, ServiceError>
